...
persisted={schema:1,order:['m2'],missions:{m2:{id:'m2',title:'Replay durable completion',goal:'Avoid duplicate work',mode:'work',status:'running',createdAt:100,updatedAt:150,startedAt:110,completedAt:null,currentStepId:null,resumeCount:0,budget:{maxSteps:1,maxAttemptsPerStep:3},steps:[{id:'apply',name:'Apply',status:'running',dependencies:[],attempts:1,startedAt:120,completedAt:null,lastError:null,checkpointId:null}],checkpoints:[{id:'cp_done',at:140,status:'running',currentStepId:'apply',completedStepIds:[],payload:{type:'step-complete',stepId:'apply',result:{ok:true}}}],toolTrace:[]}}};
