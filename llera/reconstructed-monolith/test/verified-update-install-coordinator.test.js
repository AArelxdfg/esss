...
(async()=>{
 ...
 console.log('verified update/install bridge PASS',{signedManifestGate:true,digestContinuity:true,windowsSelfTestGate:true,rollbackSurfaced:true,watchdogSafeModeGate:true});
