...
(() => {
  ...
  console.log('runtime inference admission bridge PASS', {governorEnforced:true,lowPriorityMapping:true,criticalAdmissionBlock:true,tokenReasoningProfile:true,admissionRollbackOnRuntimeFailure:true});
})();
